...
export function Scene2Analyzing({ analysisSteps, analysisResult, onFeatureSelect }) {
				...
				<div className="flex-1 flex flex-col justify-center max-w-3xl mx-auto w-full">
					...
					<div className="space-y-3">
						{analysisSteps.map((step, index) => {
							...
							const isCompleted = analysisResult && index < analysisSteps.length - 1;
							return (
								<div
									key={index}
			...
			{showResult && analysisResult && (
				<div className="flex-1 flex flex-col max-w-4xl mx-auto w-full">
					<div className="mb-6">
						...
						<div className="bg-[var(--vscode-input-background)] border border-[var(--vscode-input-border)] rounded-lg p-4 mb-4">
